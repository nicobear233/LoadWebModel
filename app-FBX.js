...
const init = () => {
    ...
    camera = new THREE.PerspectiveCamera(45, aspect, 0.000001, 5000)
...
*/
    ...
    var ambient = new THREE.AmbientLight(0xffffff, 5); //AmbientLight,影响整个场景的光源
...
*/
    ...
    let texture = textureLoader.load("base.png")
